...
public class SubAccountServiceTest {
	...
	@Test
	public void createNewSubAccount() throws JsonParseException, JsonMappingException, IOException, ImiException {
	...
	@Test
	public void getSubAccountDetailsByFriendlyName() throws JsonParseException, JsonMappingException, IOException, ImiException {
		twilioFactoryImpl=Mockito.mock(TwilioFactoryImpl.class);
		subAccountDetails=new SubAccountDetails();
		subAccountDetails.setFriendly_name("FRIENDLY.NAME");
