...
public class UpdateNumberAop implements UrlConstants {
    ...
    public ApplicationResponse updateTwilioNumber(String number,
            ApplicationResponse applicationResponsetoModify, Provider provider,
            ApplicationResponse incomingPhoneNumber, Integer userid,
            Integer clientId, Integer groupid, Integer teamid,
        ...
        if (incomingPhoneNumber == null || subAccountDetails == null) {
            throw InboundRestException.createApiException(
                    InboundApiErrorCodes.NUMBER_USER_ASSOCIATION_EXCEPTION,
        ...
        twilioNumberUpdateUrl = getUpdatedTwilioUrl(twilioNumberUpdateUrl,
        ...
        GenericRestResponse restResponse = ImiHttpUtil.defaultHttpPostHandler(
                twilioNumberUpdateUrl, requestBody,
        ...
        if (restResponse.getResponseCode() == HttpStatus.OK.value()) {
            ...
            throw InboundRestException.createApiException(
                    InboundApiErrorCodes.UNKNOWN_PROVIDER_RESPONSE_EXCEPTION,
                    "Some Error occured while updating the number. Please check back again. Response from Twilio is "
                            + restResponse.getResponseBody());
        }
    ...
    private String getUpdatedTwilioUrl(String url,
            ApplicationResponse modifyapplication) {
        String toAppend = "?";
        if (modifyapplication.getFriendlyName() != null) {
    ...
    public ApplicationResponse updateNexmoNumber(String number,
            String countryIsoCode, ApplicationResponse application,
            Provider provider, Number numberDetails, Integer userid,
            Integer clientId, Integer groupid, Integer teamid,
            String clientname, String clientkey)
                    throws ClientProtocolException, IOException {
        ...
        if (countryIsoCode.equals("")) {
            throw InboundRestException.createApiException(
                    InboundApiErrorCodes.INVALID_COUNTRY_CODE_EXCEPTION,
        ...
        nexmoAccountUpdateUrl = getUpdatedNexmoUrl(nexmoAccountUpdateUrl,
                application);
        GenericRestResponse restResponse = ImiHttpUtil.defaultHttpPostHandler(
        ...
        if (restResponse.getResponseCode() == HttpStatus.OK.value()) {
            ...
            LOG.error(
                    "Some Error occured while updating the number. Please check back again. Response from Twilio is "
                            ...
                            + restResponse.getResponseCode());
            throw InboundRestException.createApiException(
                    InboundApiErrorCodes.INVALID_API_PARAMETERS_EXCEPTION, message);
            ...
            throw InboundRestException.createApiException(
                    InboundApiErrorCodes.UNKNOWN_PROVIDER_RESPONSE_EXCEPTION,
                    "Response from Nexmo is " + restResponse.getResponseBody()
                            + "with response code "
                            + restResponse.getResponseCode());
        }
        return applicationResponse;
    ...
    private String getUpdatedNexmoUrl(String url,
            ApplicationResponse modifyapplication) {
        String toAppend = "?";
