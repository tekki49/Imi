...
public interface UrlConstants {
	...
	public static final String TWILIO_PURCHASED_NUMBER_URL = "https://api.twilio.com/2010-04-01/Accounts/{auth_id}/IncomingPhoneNumbers.json?FriendlyName={FriendlyName}";
