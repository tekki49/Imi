...
public interface UrlConstants {
    ...
    public static final String PLIVO_APPLICATION_CREATE_URL = "https://api.plivo.com/v1/Account/MANMMWNGMWMZNKNDIWOD/Application/";
    public static final String PLIVO_APPLICATION_UPDATE_URL = "https://api.plivo.com/v1/Account/MANMMWNGMWMZNKNDIWOD/Application/{app_id}/";
    ...
    public static final String NEXMO_ACCOUNT_UPDATE_URL = "https://rest.nexmo.com/number/update/{api_key}/{api_secret}/{country}/{msisdn}";
