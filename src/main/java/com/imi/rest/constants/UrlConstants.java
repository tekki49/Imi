...
public interface UrlConstants {
    ...
    public static final String NEXMO_PHONE_SEARCH_URL = "https://rest.nexmo.com/number/search/{api_key}/{api_secret}/{country_iso}?pattern={pattern}&size=100&featues={features}&&search_pattern=1&&index={index}";
    ...
    public static final String PLIVIO_PURCHASE_URL = "https://api.plivo.com/v1/Account/MANMMWNGMWMZNKNDIWOD/PhoneNumber/{number}/";
    ...
    public static final String PLIVIO_RELEASE_URL = "https://api.plivo.com/v1/Account/MANMMWNGMWMZNKNDIWOD/Number/{number}/";
