...
public class TwilioAccountResponse {
	...
	public String toString() {
		return "ClassPojo [previous_page_uri = " + previous_page_uri + ", page_size = " + page_size
				+ ", next_page_uri = " + next_page_uri + ", accounts = " + accounts + ", page = " + page + ", start = "
				+ start + ", first_page_uri = " + first_page_uri + ", uri = " + uri + ", end = " + end + "]";
	}
