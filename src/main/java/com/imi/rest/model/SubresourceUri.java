...
public class SubresourceUri {
	...
	public String toString() {
		return "ClassPojo [recordings = " + recordings + ", sms_messages = " + sms_messages + ", conferences = "
				+ conferences + ", calls = " + calls + ", outgoing_caller_ids = " + outgoing_caller_ids
				+ ", messages = " + messages + ", authorized_connect_apps = " + authorized_connect_apps + ", sip = "
				+ sip + ", connect_apps = " + connect_apps + ", notifications = " + notifications + ", sandbox = "
				+ sandbox + ", usage = " + usage + ", available_phone_numbers = " + available_phone_numbers
				+ ", transcriptions = " + transcriptions + ", applications = " + applications + ", queues = " + queues
				+ ", incoming_phone_numbers = " + incoming_phone_numbers + ", media = " + media + "]";
	}
}