...
public class CountryPricing {
	...
	public void setOutbound_prefix_prices(List<OutBoundPrefixPrice> outbound_prefix_prices) {
	...
	public void setInbound_call_prices(List<InboundCallPrice> inbound_call_prices) {
