...
public class ClientController {
	...
	public String updateAdressToProvider(@RequestBody Customer clientRequest,
			@PathVariable("clientId2") String clientId2, @RequestHeader("provider") String provider,
	...
	public List<Customer> clientListResponse(@RequestHeader("provider") String provider,
			@PathVariable("clientId2") final String clientId2, @PathVariable("country") final String country,
			@RequestHeader(value = "userid", defaultValue = "0") Integer userid,
			@RequestHeader(value = "clientid", defaultValue = "0") Integer clientId,
			@RequestHeader(value = "groupid", defaultValue = "0") Integer groupid,
			@RequestHeader(value = "teamid", defaultValue = "0") Integer teamid,
	...
	public String updateAdressToImi(@RequestHeader(value = "provider", required = false) String provider,
			@RequestBody Customer clientRequest, @PathVariable("clientId2") final String clientId2,
	...
	public String clientListResponse(@PathVariable("clientId2") final String clientId2,
