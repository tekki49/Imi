...
public class ProvisionController {
    ...
    private static final Logger LOG = Logger
            .getLogger(ProvisionController.class);
    ...
    public ApplicationResponse provisionNumber(
        ...
        ApplicationResponse applicationResponse = provisionService
                .provisionNumber(number, countryIsoCode, providerObj, userid,
    ...
    public ApplicationResponse provisionNumber(
        ...
        ApplicationResponse applicationResponse = provisionService
                .provisionNumber(number, "", providerObj, userid, clientId,
    ...
    public ApplicationResponse provisionNumbers(
        ...
        LOG.info("Inside ProvisionController");
        ApplicationResponse applicationResponse = provisionService
                .provisionAllNumbers(providerName, application, userid,
                        clientId, groupid, teamid, clientname, clientkey);
        return applicationResponse;
    }
    ...
    public ApplicationResponse getApplication(
        ...
        LOG.info("Inside ProvisionController");
        ApplicationResponse applicationResponse = provisionService
                .getApplication(providerName, appId);
        return applicationResponse;
    }
}
