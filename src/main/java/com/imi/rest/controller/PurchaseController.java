    ...
    public PurchaseResponse purchaseNumber(
        ...
        if (ImiDataFormatUtils.isNumber(purchaseRequest.getProvider())) {
            providerObj = providerService.getProviderById(Integer
                    .parseInt(purchaseRequest.getProvider()));
        } else {
            providerObj = providerService.getProviderByName(purchaseRequest
                    .getProvider() == null ? "" : purchaseRequest.getProvider()
                    .toUpperCase());
        }
        ...
        purchaseRequest = ImiDataFormatUtils
                .formatPurchaseRequest(purchaseRequest);
        PurchaseResponse purchaseResponse = purchaseNumberService
                .purchaseNumber(purchaseRequest.getNumber(),
                        purchaseRequest.getNumberType(), providerObj, country,
                        serviceTypeEnum, userid, clientId, groupid, teamid,
