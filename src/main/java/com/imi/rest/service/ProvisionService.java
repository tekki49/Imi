...
public class ProvisionService implements ProviderConstants {
    ...
    public ApplicationResponse provisionNumber(String number,
            String countryIsoCode, Provider provider, Integer userid,
        ...
        VoiceRouteMaster voiceRouteMaster = voiceRouteMasterDao
                .getResourceById(provider.getId(), country.getCountryCode(),
        ...
        if (provider.getName().equalsIgnoreCase(PLIVO)) {
            ...
            applicationResponse = plivoFactoryImpl.updateNumber(number,
                    application, providerService.getPlivioProvider(), userid,
    ...
    public ApplicationResponse provisionAllNumbers(String providerName,
            ApplicationResponse application, Integer userid, Integer clientId,
    ...
    public ApplicationResponse updateApplication(String providerName,
            ApplicationResponse application) throws 
