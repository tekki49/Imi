 ...
 */
@Entity
@Table(name = "user_address_mgmt", schema = "ump_identity_mgr")
public class UserAddressMgmt implements java.io.Serializable {
	...
	public UserAddressMgmt(String companyName, Integer mobile, String address, String city, String state,
			Integer postalCode, String country, Integer countryCode, Integer userId) {
